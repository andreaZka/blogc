...
import AndreaZkaBlogcAndreazkaBlogcBlogc from './andreaZka/blogc/andreazka.blogc.blogc'
...
export default { 
  AndreaZkaBlogcAndreazkaBlogcBlogc: load(AndreaZkaBlogcAndreazkaBlogcBlogc, 'andreazka.blogc.blogc'),
